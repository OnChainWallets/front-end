import { Plan } from "@/src/utils/constants/plans";
...
export function CardPlan({ className, plan, yearlyPlans }: CardPlanProps) {
    ...
    return (
        <div
            className={twMerge('relative col-span-4 xl:col-span-1 w-full h-full bg-gradient-to-br from-zinc-700 to-zinc-950 rounded-lg p-6 flex flex-col justify-start items-center space-y-5 divide-violet-500 divide-y-2', className)}
        >
            ...
            <ul className="w-full flex flex-col justify-center items-start gap-4 py-6">
                <li className="flex justify-center items-center gap-3 "><CheckCircleIcon className="w-4 h-4 text-emerald-500" />{plan.benefits.blockChain}</li>
