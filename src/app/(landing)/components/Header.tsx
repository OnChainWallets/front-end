...
export function Header() {
    return (
        <Collapsible.Root className="fixed left-0 right-0 top-0 flex flex-col gap-6 p-4 data-[state=open]:bottom-0 data-[state=open]:overflow-y-hidden lg:right-auto lg:data-[state=closed]:bottom-0 lg:sticky z-10 bg-zinc-950 bg-opacity-20 backdrop-blur-md lg:flex-row justify-between px-40 py-6">
